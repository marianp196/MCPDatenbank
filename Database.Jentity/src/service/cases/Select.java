...
public class Select {
    ...
    public Select(ISelectSql selectSql, IDatabaseDtoSqlService databaseDtoSqlService) {
    ...
    private <TDto> Collection<TDto> getInstancesFromResultSet(ResultSet resultSet, Class<TDto> type) throws Exception {
        ...
        {
            TDto dto = createInstance(type, resultSet, fields);
            result.add(dto);
        }
        return result;
    }

    private <TDto> TDto createInstance(Class<TDto> type, ResultSet resultSet, Collection<DtoSqlField> fields) throws SQLException, IllegalAccessException, InstantiationException, IllegalArgumentException {
